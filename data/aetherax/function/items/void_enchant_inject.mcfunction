# Void enchant: first-hit silent injection
# @s = player who attacked with netherite sword (no materials = silent fail)
...
# Try to consume template (silent fail)
...
# Try to consume void star (silent fail)
